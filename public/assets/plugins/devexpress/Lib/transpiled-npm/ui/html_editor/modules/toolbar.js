...
if (_devextremeQuill.default) {
  ...
  ToolbarModule = /*#__PURE__*/function (_BaseModule) {
    ...
    _proto._getDefaultClickHandler = function _getDefaultClickHandler(formatName) {
      var _this2 = this;
    ...
    _proto._updateFormatWidget = function _updateFormatWidget(formatName, isApplied, formats) {
    ...
    _proto._prepareShortcutHandler = function _prepareShortcutHandler(formatName, shortcutValue) {
      var _this4 = this;
    ...
    _proto._prepareButtonItemConfig = function _prepareButtonItemConfig(formatName) {
    ...
    _proto._prepareColorClickHandler = function _prepareColorClickHandler(formatName) {
      var _this12 = this;
    ...
    _proto._getDefaultConfig = function _getDefaultConfig(formatName) {
    ...
    _proto._isColorFormat = function _isColorFormat(formatName) {
      return formatName === 'color' || formatName === 'background';
    };

    _proto._updateColorWidget = function _updateColorWidget(formatName, color) {
    ...
    _proto._getFormatWidgetName = function _getFormatWidgetName(formatName, formats) {
      var widgetName;
    ...
    _proto.addClickHandler = function addClickHandler(formatName, handler) {
