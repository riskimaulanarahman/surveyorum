...
var FileManagerContextMenu = /*#__PURE__*/function (_Widget) {
  ...
  _proto.showAt = function showAt(fileItems, element, offset, targetFileItem) {
    if (this._isVisible) {
  ...
  _proto._extendAttributes = function _extendAttributes(targetObject, sourceObject, objectKeysArray) {
