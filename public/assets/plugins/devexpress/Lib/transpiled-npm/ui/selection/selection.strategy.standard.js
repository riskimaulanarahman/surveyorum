...
var _default = _selection.default.inherit({
  ...
  _loadSelectedItems: function _loadSelectedItems(keys, isDeselect, isSelectAll) {
    ...
    if (isMultiSelectEnabled) {
      ...
      if (((_that$_lastLoadDeferr = that._lastLoadDeferred) === null || _that$_lastLoadDeferr === void 0 ? void 0 : _that$_lastLoadDeferr.state()) === 'pending' && !(0, _array_compare.isKeysEqual)(keys, this.options.selectedItemKeys)) {
    ...
    (0, _deferred.when)(that._lastLoadDeferred).always(function () {
      ...
      if (isMultiSelectEnabled && !isDeselect) {
        ...
        currentKeys = (0, _array.removeDuplicates)(keys.concat((_that$_lastRequestDat = that._lastRequestData) === null || _that$_lastRequestDat === void 0 ? void 0 : _that$_lastRequestDat.addedItems), (_that$_lastRequestDat2 = that._lastRequestData) === null || _that$_lastRequestDat2 === void 0 ? void 0 : _that$_lastRequestDat2.removedItems);
