...
var VirtualSelectionState = /*#__PURE__*/function () {
  ...
  _proto.getFocusedCell = function getFocusedCell(isVerticalGroupOrientation) {
  ...
  _proto._getColumnIndexByCellData = function _getColumnIndexByCellData(cellData, isVerticalGroupOrientation) {
  ...
  _proto._getRowIndexByColumnAndData = function _getRowIndexByColumnAndData(cellData, columnIndex, isVerticalGroupOrientation) {
    var viewDataMap = this._viewDataProvider.viewDataMap;
    var startDate = cellData.startDate,
        groupIndex = cellData.groupIndex,
  ...
  _proto._filterCellsByDate = function _filterCellsByDate(cellsRow, firstDate, lastDate) {
