...
var SchedulerWorkSpace = /*#__PURE__*/function (_WidgetObserver) {
  ...
  _proto2.generateRenderOptions = function generateRenderOptions() {
    var groupCount = this._getGroupCount();
  ...
  _proto2._attachGroupCountAttr = function _attachGroupCountAttr(groupRowCount, groupRows) {
  ...
  _proto2._toggleAllDayVisibility = function _toggleAllDayVisibility() {
  ...
  _proto2.getCoordinatesByDateInGroup = function getCoordinatesByDateInGroup(startDate, appointmentResources, inAllDayRow) {
    var _this10 = this;
  ...
  _proto2.getMaxAllowedPosition = function getMaxAllowedPosition() {
  ...
  _proto2.getMaxAllowedVerticalPositionVirtual = function getMaxAllowedVerticalPositionVirtual(groupIndex) {
    var _this14 = this;
