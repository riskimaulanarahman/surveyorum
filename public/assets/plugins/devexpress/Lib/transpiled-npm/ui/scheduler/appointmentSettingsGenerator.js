...
var AppointmentSettingsGeneratorBaseStrategy = /*#__PURE__*/function () {
  ...
  _proto2._createGridAppointmentList = function _createGridAppointmentList(appointmentList, appointment) {
    ...
    return appointmentList.map(function (source) {
      ...
      if (offsetDifference !== 0 && _this3._canProcessNotNativeTimezoneDates(appointment)) {
  ...
  _proto2._createAppointmentInfos = function _createAppointmentInfos(gridAppointments, resources, allDay, recurrent) {
    var _this6 = this;
...
var AppointmentSettingsGeneratorVirtualStrategy = /*#__PURE__*/function (_AppointmentSettingsG) {
  ...
  _proto3._createAppointmentInfos = function _createAppointmentInfos(gridAppointments, resources, allDay, recurrent) {
    var _this7 = this;
