...
var ViewDataGenerator = /*#__PURE__*/function () {
  ...
  _proto._getViewDataFromMap = function _getViewDataFromMap(viewDataMap, completeViewDataMap, options) {
  ...
  _proto._generateViewCellsData = function _generateViewCellsData(options, renderRowCount, startRowIndex, rowOffset) {
  ...
  _proto._generateAllDayPanelData = function _generateAllDayPanelData(options, groupIndex, rowCount, cellCount) {
  ...
  _proto._generateCellsRow = function _generateCellsRow(options, cellDataGetters, rowIndex, cellCount, rowIndexInGroup, groupIndex) {
    var _this = this;
  ...
  _proto._getKeyByRowAndColumn = function _getKeyByRowAndColumn(rowIndex, columnIndex, cellCount) {
  ...
  _proto._isFirstGroupCell = function _isFirstGroupCell(rowIndex, columnIndex, singleGroupRowCount, singleGroupColumnCount, groupCount) {
  ...
  _proto._isLastGroupCell = function _isLastGroupCell(rowIndex, columnIndex, singleGroupRowCount, singleGroupColumnCount, groupCount) {
    if (this.workspace.isGroupedByDate()) {
...
var ViewDataProvider = /*#__PURE__*/function () {
  ...
  _proto2.update = function update(isGenerateNewViewData) {
  ...
  _proto2.getStartDate = function getStartDate() {
  ...
  _proto2.getCellData = function getCellData(rowIndex, cellIndex, isAllDay) {
  ...
  _proto2.getCellsByGroupIndexAndAllDay = function getCellsByGroupIndexAndAllDay(groupIndex, allDay) {
  ...
  _proto2.findCellPositionInMap = function findCellPositionInMap(groupIndex, startDate, isAllDay) {
  ...
  _proto2._getLastGroupRow = function _getLastGroupRow(groupIndex) {
  ...
  _proto2.getLasGroupCellIndex = function getLasGroupCellIndex(groupIndex) {
    var group = this.groupedDataMap[groupIndex];
  ...
  _proto2.getGroupData = function getGroupData(groupIndex) {
    var groupedData = this.viewData.groupedData;
  ...
  _proto2.isGroupIntersectDateInterval = function isGroupIntersectDateInterval(groupIndex, startDate, endDate) {
    var groupStartDate = this.getGroupStartDate(groupIndex);
    var groupEndDate = this.getGroupEndDate(groupIndex);
    return startDate < groupEndDate && endDate > groupStartDate;
  };

  _proto2.findGlobalCellPosition = function findGlobalCellPosition(date) {
  ...
  _proto2._compareDatesAndAllDay = function _compareDatesAndAllDay(date, cellStartDate, cellEndDate, allDay) {
