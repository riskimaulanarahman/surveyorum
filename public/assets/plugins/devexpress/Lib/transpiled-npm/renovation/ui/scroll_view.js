...
var ScrollView = (0, _compat.forwardRef)(function scrollView(props, ref) {
  ...
  var __getBoundaryProps = (0, _hooks.useCallback)(function __getBoundaryProps() {
  ...
  var __isDirection = (0, _hooks.useCallback)(function __isDirection(direction) {
  ...
  var __getScrollBarSize = (0, _hooks.useCallback)(function __getScrollBarSize(dimension) {
    return __containerRef.current["offset".concat(dimension)] - __containerRef.current["client".concat(dimension)];
  }, []);

  var __getScrollLocation = (0, _hooks.useCallback)(function __getScrollLocation(element, scrollOffset, direction) {
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var children = props.children,
        ...
        width = props.width,
        restProps = _objectWithoutProperties(props, ["children", "direction", "disabled", "height", "onScroll", "rtlEnabled", "width"]);
  ...
  (0, _hooks.useEffect)(function () {
    return (0, _subscribe_to_event.subscribeToScrollEvent)(__containerRef.current, function (event) {
      ...
      return (_props$onScroll = props.onScroll) === null || _props$onScroll === void 0 ? void 0 : _props$onScroll.call(props, _objectSpread({
        event: event,
