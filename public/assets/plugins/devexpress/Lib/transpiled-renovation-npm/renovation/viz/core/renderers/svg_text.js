...
function TextSvgElement(props) {
  ...
  var __textItems = (0, _hooks.useCallback)(function __textItems() {
    var items;
    var parsedHtml;
    var text = props.text;
    if (!text) return;
  ...
  var __isStroked = (0, _hooks.useCallback)(function __isStroked() {
    return (0, _type.isDefined)(props.stroke) && (0, _type.isDefined)(props.strokeWidth);
  }, [props.stroke, props.strokeWidth]);

  var __textAnchor = (0, _hooks.useCallback)(function __textAnchor() {
    return (0, _utils.convertAlignmentToAnchor)(props.align, props.rtl);
  }, [props.align, props.rtl]);

  var __parseTspanElements = (0, _hooks.useCallback)(function __parseTspanElements(texts) {
  ...
  var __alignTextNodes = (0, _hooks.useCallback)(function __alignTextNodes(items) {
  ...
  var __locateTextNodes = (0, _hooks.useCallback)(function __locateTextNodes(items) {
  ...
  var __strokeTextNodes = (0, _hooks.useCallback)(function __strokeTextNodes(items) {
    if (!__isStroked()) return;
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var _props$sharp = _objectSpread(_objectSpread({}, props), {}, {
      sharp: props.sharp !== undefined ? props.sharp : __state_sharp
        ...
        styles = _props$sharp.styles,
        text = _props$sharp.text,
        textsAlignment = _props$sharp.textsAlignment,
        translateX = _props$sharp.translateX,
        translateY = _props$sharp.translateY,
        x = _props$sharp.x,
        y = _props$sharp.y,
        restProps = _objectWithoutProperties(_props$sharp, ["align", "dashStyle", "defaultSharp", "encodeHtml", "fill", "opacity", "rotate", "rotateX", "rotateY", "rtl", "scaleX", "scaleY", "sharp", "sharpChange", "sharpDirection", "stroke", "strokeOpacity", "strokeWidth", "styles", "text", "textsAlignment", "translateX", "translateY", "x", "y"]);
