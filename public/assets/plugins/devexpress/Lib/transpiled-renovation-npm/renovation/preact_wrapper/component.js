...
var PreactWrapper = /*#__PURE__*/function (_DOMComponent) {
  ...
  _proto._renderPreact = function _renderPreact(props) {
  ...
  _proto._createTemplateComponent = function _createTemplateComponent(props, templateOption) {
    if (!templateOption) {
      return;
    }
  ...
  _proto.setAria = function setAria() {
